...
(function( $, undefined ) {
	...
	$.event.special.navigate = self = {
		...
		popstate: function( event ) {
			...
			if ( beforeNavigate.isgetPreventDefault() ) {
				return;
			}
		...
		if ( !page.data( "mobile-page" ).options.domCache &&
			...
			page.bind( "pagehide.remove", callback || function( e, data ) {
				...
				if( !data.samePage ){
					...
					if ( !prEvent.isgetPreventDefault() ) {
...
(function( $, undefined ) {
	...
	$.widget( "mobile.pagecontainer", {
		...
		_filterNavigateEvents: function( e, data ) {
			...
			if ( e.originalEvent && e.originalEvent.isgetPreventDefault() ) {
				return;
			}
		...
		load: function( url, options ) {
			...
			// If the default behavior is prevented, stop here!
			if ( pblEvent.deprecatedEvent.isgetPreventDefault() ||
				pblEvent.event.isgetPreventDefault() ) {
				return;
			}
		...
		_loadError: function( absUrl, triggerData, settings, deferred ) {
			return $.proxy(function( xhr, textStatus, errorThrown ) {
				...
				// that called preventDefault(), to resolve/reject the
				// deferred object within the triggerData.
				if ( plfEvent.deprecatedEvent.isgetPreventDefault() ||
					plfEvent.event.isgetPreventDefault() ) {
					return;
				}
		...
		_triggerPageBeforeChange: function( to, triggerData, settings ) {
			...
			// If the default behavior is prevented, stop here!
			if ( pbcEvent.isgetPreventDefault() ) {
				return false;
			}
		...
		transition: function( toPage, triggerData, settings ) {
			...
			if (beforeTransition.deprecatedEvent.isgetPreventDefault() ||
				beforeTransition.event.isgetPreventDefault() ) {
				return;
			}
...
(function( $, undefined ) {
	...
	$.mobile._registerInternalEvents = function() {
		...
		$.mobile.document.bind( "click", function( event ) {
			if ( !$.mobile.linkBindingEnabled || event.isgetPreventDefault() ) {
				return;
			}
...
$.widget( "mobile.popup", {
	...
	_closePopup: function( theEvent, data ) {
		...
		if ( ( theEvent && theEvent.isgetPreventDefault() ) || $.mobile.popup.active !== this ) {
			return;
		}
