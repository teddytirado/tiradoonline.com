<%@ Page language="c#" Inherits="mla_gui.ConnInfo"  %>
		...
		<div id="zFullZone"><div id="zFullZone_1">
			...
			<div id="zPageContent"><div id="zPageContent_Container" runat="server">				
				...
				<div id="zForm_Container">
					...
					<div id="zTab_Connection" class="zonetab">
						<div id="zInfoConnection" runat="server" />
					</div>

					<div id="zTab_License" class="zonetab">
						<div id="zInfoLicense" runat="server" />
					</div>
