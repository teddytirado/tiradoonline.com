<%@ Page language="c#" Inherits="mla_gui.NewIndex"  %>
		...
		<div id="zFullZone"><div id="zFullZone_1">
			...
			<div id="zPageContent"><div id="zPageContent_Container" runat="server">				
				<div id="zForm_Container">
					...
					<div id="zTab_IncludedColumns" class="zonetab">
						<asp:Label id="zIncludedColumnsInfo" runat="server" /><br /><br />
						<div id="zIndexIncludedColumns">
							<asp:Label id="zIncludedColumns" class="columnListTitle" runat="server" />
							<div id="zIncludedColumnList">
								<asp:PlaceHolder id="zIncludedFields" runat="server" />
							</div>
						</div>
					</div>
